...
const Integrantes = () => {
    return (
        <div id="integrantes" className="p-6 flex flex-col items-center justify-center mt-20 mx-auto gap-6">
            ...
            <h2 className="text-3xl font-bold text-primario mb-6">Comisión Directiva</h2>

            <div className="flex items-center justify-center gap-12">
                
                <div className="flex flex-col items-center justify-center gap-4 bg-gray-50 py-6 px-12 rounded-xl shadow-lg">
            ...
            <h2 className="text-3xl font-bold text-primario mt-12 mb-6">Vocales</h2>
