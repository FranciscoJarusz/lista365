    ...
    return (
        <div id="recursos" className="p-6 flex flex-col items-center justify-center mt-20">
            ...
            <div className="flex flex-col items-center justify-center gap-6">            
                ...
                <h1 className="text-4xl md:text-6xl font-bold text-black flex items-center gap-4">

                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 640 640" fill="var(--color-primario)">
                    ...
                    <span className="text-primario">Recursos</span> útiles
